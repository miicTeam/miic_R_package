...
double* computeEnsInformation(structure::Environment&, int*, int, int*, int,
		int, int, int, int);
...
double* computeEnsInformationContinuous(structure::Environment&, int* myCond,
		int myNbrUi, int* myZi, unsigned int myNbrZi, int myZiPos,
		int myVarIdxX, int myVarIdxY, int cplx, structure::MemorySpace&);
double* computeEnsInformationContinuous_Orientation(structure::Environment&,
		int* myCond, int myNbrUi,
		int* myZi, int myVarIdxX, int myVarIdxY, int cplx,
		structure::MemorySpace&);
//Gaussian case
