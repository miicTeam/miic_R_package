...
miic.write.network.cytoscape <- function(g, layout=NULL, file) {
  ...
  if (is.null(layout)) {
    ...
    line = paste(line, "\n", sep="")
    indexes = which(summary["type"] == "P" | summary["type"] == "TP" | summary["type"] == "FP")
    ...
    for(index in indexes) {
      ...
      if (summary[index, "infOrt"] == 1) {
        line = paste(line, "\t\t<edge target=\"", summary[index, 2], "\" source=\"", summary[index, 1], "\" directed=\"false\">\n", sep="")
        line = paste(line, "\t\t\t<data key=\"label\">",  summary[index, 2], "---", summary[index, 1], "</data>\n", sep="")
        line = paste(line, "\t\t\t<data key=\"edgeType\">1</data>\n", sep="")
      } else if (summary[index, "infOrt"] == 2) {
        line = paste(line, "\t\t<edge target=\"", summary[index, 2], "\" source=\"", summary[index, 1], "\" directed=\"true\">\n", sep="")
        ...
        line = paste(line, "\t\t<edge target=\"", summary[index, 1], "\" source=\"", summary[index, 2], "\" directed=\"true\">\n", sep="")
        line = paste(line, "\t\t\t<data key=\"sourceArrowShape\">none</data>\n", sep="")
        if (is.na(summary[index, "partial_correlation"])) {
          line = paste(line, "\t\t\t<data key=\"targetArrowShape\">arrow</data>\n", sep="")
          line = paste(line, "\t\t\t<data key=\"label\">",  summary[index, 1], "--&gt;", summary[index, 2], "</data>\n", sep="")
        } else {
          if (summary[index, "partial_correlation"] > 0) {
            line = paste(line, "\t\t\t<data key=\"targetArrowShape\">arrow</data>\n", sep="")
            line = paste(line, "\t\t\t<data key=\"label\">",  summary[index, 1], "--&gt;", summary[index, 2], "</data>\n", sep="")
      ...
      line = paste(line, "\t\t\t<data key=\"upstream\">", summary[index, "ai"] , "</data>\n", sep="")
      line = paste(line, "\t\t\t<data key=\"complexity\">", summary[index, "cplx"] , "</data>\n", sep="")
      line = paste(line, "\t\t\t<data key=\"nSamples\">", summary[index, "Nxy_ui"] , "</data>\n", sep="")
      line = paste(line, "\t\t\t<data key=\"confidenceRatio\">", summary[index, "confidence_ratio"] , "</data>\n", sep="")
      line = paste(line, "\t\t\t<data key=\"log_confidence\">", summary[index, "log_confidence"] , "</data>\n", sep="")
      line = paste(line, "\t\t\t<data key=\"sign\">", summary[index, "sign"] , "</data>\n", sep="")
      line = paste(line, "\t\t\t<data key=\"partialCorrelation\">", summary[index, "partial_correlation"] , "</data>\n", sep="")
    ...
    for(index in indexes) {
        ...
        targetArrowNum = 0
      if (summary[index, "infOrt"] == 1) {
        line = paste(line, "\t\t<edge label=\"", summary[index, 2], "---", summary[index, 1],
                     "\" target=\"", summary[index, 2], "\" source=\"", summary[index, 1], "\">\n", sep="")
        line = paste(line, "\t\t\t<att name=\"edgeType\" type=\"integer\" value=\"1\"/>\n", sep="")
      } else if (summary[index, "infOrt"] == 2) {
        if (is.na(summary[index, "partial_correlation"])) {
          value="arrow"
          varchar=intToUtf8(187)
          label= paste(summary[index, 1], "--&gt;", summary[index, 2], sep="")
        } else {
          if (summary[index, "partial_correlation"] > 0) {
            value="arrow"
            varchar=intToUtf8(187)
        ...
        if (is.na(summary[index, "partial_correlation"])) {
          value="arrow"
          varchar=intToUtf8(187)
          label= paste(summary[index, 2], "--&gt;", summary[index, 1], sep="")
        } else {
          if (summary[index, "partial_correlation"] > 0) {
            value="arrow"
            varchar=intToUtf8(187)
        ...
        line = paste(line, "\t\t<edge label=\"", label,
                     "\" target=\"", summary[index, 1], "\" source=\"", summary[index, 2], "\">\n", sep="")
        line = paste(line, "\t\t\t<att name=\"targetArrowShape\" type=\"string\" value=\"", value , "\"/>\n", sep="")
        line = paste(line, "\t\t\t<att name=\"sourceArrowShape\" type=\"string\" value=\"none\"/>\n", sep="")
        line = paste(line, "\t\t\t<att name=\"edgeType\" type=\"integer\" value=\"2\"/>\n", sep="")
        sourceArrowNum = 0
      ...
      line = paste(line, "\t\t\t<att name=\"upstream\" type=\"string\" value=\"", summary[index, "ai"] , "\"/>\n", sep="")
      line = paste(line, "\t\t\t<att name=\"complexity\" type=\"double\" value=\"", summary[index, "cplx"] , "\"/>\n", sep="")
      line = paste(line, "\t\t\t<att name=\"nSamples\" type=\"integer\" value=\"", summary[index, "Nxy_ai"] , "\"/>\n", sep="")
      line = paste(line, "\t\t\t<att name=\"confidenceRatio\" type=\"double\" value=\"", summary[index, "confidence_ratio"] , "\"/>\n", sep="")
      line = paste(line, "\t\t\t<att name=\"log_confidence\" type=\"double\" value=\"", summary[index, "log_confidence"] , "\"/>\n", sep="")
      line = paste(line, "\t\t\t<att name=\"sign\" type=\"string\" value=\"", summary[index, "sign"] , "\"/>\n", sep="")
      line = paste(line, "\t\t\t<att name=\"partialCorrelation\" type=\"double\" value=\"", summary[index, "partial_correlation"] , "\"/>\n", sep="")
