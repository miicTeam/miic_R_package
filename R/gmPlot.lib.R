#*****************************************************************************
# All the below functions are integrated in the miic.plot function
#*****************************************************************************
...
#     mySummary <- mySummary[-myLinesToIgnore, ]
#   }
#   return(mySummary)
# }
# 
...
# }
# 
# # ---- Function to plot graphes with edges matching to their partial
# # correlation
...
#   # Set the color vector for the edges
#   myEdgesColor <- rep(NA, nrow(summary))
#   # get the maximum negative pcor
#   max.pcor.neg <- suppressWarnings(min(summary[
#     which(summary[, "sign"] == "-"),
#     "partial_correlation"
#   ]))
#   # get the maximum positive pcor
#   max.pcor.pos <- suppressWarnings(max(summary[
#     which(summary[, "sign"] == "+"),
#     "partial_correlation"
#   ]))
...
# }
# 
# # ---- Function to plot graphes with edges matching to their mutual information
...
#     if (edge.colIndex < min.conf) {
#       edge.colIndex <- 1
#     } else if (edge.colIndex > max.conf) {
#       edge.colIndex <- 100
#     }
#     ### Get the sign of the link to look at the correct color gradient
#     if (!is.na(summary[edge, "sign"])) {
