...
miic.orient <- function(inputData = NULL, cntVar = NULL, stateOrder = NULL, edges = NULL, effN = -1,
                        cplx = "nml", eta = 1, latent = FALSE, propagation = TRUE, typeOfData = NULL, 
                        sampleWeights = NULL, hvs = FALSE, continuous = 0, verbose = FALSE)
{
  isK23 = TRUE
  isDegeneracy = FALSE
  ...
  res <- .Call('orientationProbability',inData, typeOfData, cntVar, numNodes, edges, effN, cplx, eta, hvs, latent,
                isK23, isDegeneracy, propagation, sampleWeights, verbose)
