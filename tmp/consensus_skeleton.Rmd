...
In order to perform the simulations, I wrote a benchmark script (benchmark.R) whose code is shown below:
```{r eval=FALSE, echo=TRUE}
library(dplyr)
library(ggplot2)
library(purrr)
...
scatter3D(x=alarm$`Consensus %`, y=alarm$Fraction, z=alarm$`Fscore Cons-EF`,
          clab=c("Fscore diff"), pch=19, ticktype = "detailed", bty = "b2", phi = 0,
